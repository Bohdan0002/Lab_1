...
public class Main {
    public static void main(String[] args) {
        ...
        String word2 = " гасаю " ;
        String word3 = " на " ;
        String word4 = " пассаті, " ;
        String word5 = " слухаючи " ;
        String word6 = " музику " ;
        String word7 = " Скрябіна " ;
        String word8 = " з " ;
        String word9 = " кентами " ;
        String word10  = "." ;
        ...
        User user1 = new User(1, 19, "Bodeo", "Passat", 71.5, 173.0);
        ...
        User user5 = new User(5, 19, "Ostixx", "Vectra", 65.0, 171.0);
        ...
        Car car1 = new Car(140, 2.0, "VW", "PASSAT", 1993, true);
        Car car2 = new Car(110, 2.0, "Chevrolet", "Aveo", 2018, false);
        Car car3 = new Car(150, 1.8, "Toyota", "Supra", 2020, true);
        Car car4 = new Car(625, 4.4, "BMW", "M5E39", 1994, true);
